...
export const clinicalData = {
    ...
    bloodProfiles: {
        ...
        "AE Major Haemorrhage": [{ name: "FBC", why: "Baseline Hb/platelets" }, { name: "Clotting Screen", why: "Baseline coagulation status" }, { name: "Fibrinogen", why: "Guides massive transfusion protocol/cryoprecipitate need" }, { name: "Group & Crossmatch", why: "Urgent crossmatch for major haemorrhage protocol" }],
        ...
        "AE PV Bleed": [{ name: "FBC", why: "Baseline Hb" }, { name: "G&S", why: "In case of significant blood loss" }, { name: "Clotting Screen", why: "Exclude coagulopathy if heavy bleeding" }],
    ...
    protocols: {
        ...
        "Major Trauma": { cannula: { status: "Essential", color: "green", size: "14G/16G x2", reason: "Trauma Call" }, tests: { bedside: [{ name: "FAST Scan", why: "Rapid detection of free intraperitoneal/pericardial fluid" }, { name: "VBG", why: "Rapid lactate/Hb/base excess to guide resuscitation" }], labProfile: "AE Major Haemorrhage" } },
        ...
        "PV Bleeding": { cannula: { status: "Consider", color: "amber", size: "18G", reason: "Bleeding Risk/Anaemia" }, tests: { bedside: [{ name: "Pregnancy Test", why: "Essential to exclude ectopic/miscarriage as cause" }], labProfile: "AE PV Bleed", labExtra: [{ name: "Rhesus Group", why: "Add if patient is or may be pregnant" }] } },
