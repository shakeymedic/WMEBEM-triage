// protocols.js - Clinical Configuration v9.0 (Data Only)
// IMPROVEMENTS: Frailty descriptions, Paeds safety caps, prioritized lists.
...
const clinicalData = {
    ...
    screening: {
        ...
        frailty: {
            ...
            options: [
                { val: "1", text: "1. Very Fit - Active, energetic" },
                { val: "2", text: "2. Well - No active disease" },
                { val: "3", text: "3. Managing Well - Medically controlled" },
                { val: "4", text: "4. Vulnerable - Limited activities" },
                { val: "5", text: "5. Mildly Frail - Needs help with IADLs" },
                { val: "6", text: "6. Moderately Frail - Needs help with ADLs" },
                { val: "7", text: "7. Severely Frail - Dependent" },
                { val: "8", text: "8. Very Severely Frail - Approaching end of life" },
                { val: "9", text: "9. Terminally Ill - <6m prognosis" }
            ]
        },
        alcohol: {
    ...
    // --- 3. MTS DATA (Snippet - Full list assumed) ---
    // Sorted logic will happen in app.js
    mtsFlowcharts: {
        ...
        // ... (Add remaining flowcharts here)
    },

    // --- 4. PROTOCOLS ---
    protocols: {
        "Chest Pain": {
            details: "Central crushing chest pain? Radiation?",
            do: ["ECG", "Troponin", "CXR", "FBC", "U&E"],
            consider: ["D-Dimer (if pleuritic)", "ABG"],
            conditionals: [{ question: "Cardiac History?", add: "Compare Old ECG" }]
        },
        "Abdominal Pain": {
            details: "Site? Radiation? Guarding?",
            do: ["Urine Dip", "Pregnancy Test (Female)", "U&E", "Lactate"],
            consider: ["Amylase", "G&S", "Erect CXR"],
            conditionals: [{ question: "Upper Abdo Pain?", add: "ECG" }]
        }
        // ... (Add remaining protocols here)
    }
};

// Export for usage
if (typeof window !== 'undefined') window.clinicalData = clinicalData;
